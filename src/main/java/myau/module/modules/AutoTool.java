package myau.module.modules;
  ...
  public class AutoTool extends Module {
      ...
      private boolean isManualBlocking() {
          ManualBlock manualBlock = (ManualBlock)
  Myau.moduleManager.modules.get(ManualBlock.class);
          return manualBlock != null && manualBlock.isBlocking();
      }
      ...
      public void onTick(TickEvent event) {
          if (this.isEnabled() && event.getType() == EventType.PRE) {
              ...
              if (this.currentToolSlot != -1 && this.currentToolSlot !=
  mc.thePlayer.inventory.currentItem) {
                  this.currentToolSlot = -1;
                  this.previousSlot = -1;
              }

              // Don't swap if player is block-hitting with a sword
              if (this.isManualBlocking() && this.isHoldingSword()) {
